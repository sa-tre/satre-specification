...
| Penetration tests should be carried out on TREs | By intentionally testing or attempting to breach the TRE's security measures, organisations can proactively discover and address potential vulnerabilities before they are exploited maliciously.|
