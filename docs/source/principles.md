...
- Owing to the broad definition of [TREs](https://glossary.uktre.org/en/stable/#term-trusted-research-environment-TRE), there are currently no technical or information governance standards focused on TREs.
