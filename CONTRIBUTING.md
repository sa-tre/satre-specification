...
*These contributing guidelines can also be seen on our [readthedocs site](https://satre-specification.readthedocs.io/en/latest/contributing.html#contribution-process)
