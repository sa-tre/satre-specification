...
TREs are designed to enable access to sensitive data only for authorised projects and data analysts, whilst minimising risk of data release or exposure.
